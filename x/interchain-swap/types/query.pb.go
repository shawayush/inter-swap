...
// source: interchain-swap/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "shawayush.inter-swap.interchain-swap.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "shawayush.inter-swap.interchain-swap.QueryParamsResponse")
	proto.RegisterType((*QueryQueryStateRequest)(nil), "shawayush.inter-swap.interchain-swap.QueryQueryStateRequest")
	proto.RegisterType((*QueryQueryStateResponse)(nil), "shawayush.inter-swap.interchain-swap.QueryQueryStateResponse")
}

func init() { proto.RegisterFile("interchain-swap/query.proto", fileDescriptor_e4dbde4cc18f461f) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/shawayush.inter-swap.interchain-swap.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) QueryState(ctx context.Context, in *QueryQueryStateRequest, opts ...grpc.CallOption) (*QueryQueryStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/shawayush.inter-swap.interchain-swap.Query/QueryState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shawayush.inter-swap.interchain-swap.Query/Params",
	}
...
func _Query_QueryState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/shawayush.inter-swap.interchain-swap.Query/QueryState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "shawayush.inter-swap.interchain-swap.Query",
	...
	Metadata: "interchain-swap/query.proto",
}
